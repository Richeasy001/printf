...
/************************* HANDLE *************************/
/**
 * handle_write_char - string printer
 * @c: char
...
/**
 * write_num - Write a buffer number
 * @ind: Index at which the number starts on the buffer
 * @buffer: spec of buffer
 * @flags: spec of flags
 * @width: spec of width
 ...
 * @ind: Index to start buffer number starts
 * @buffer: chars arrays
...
/**
 * write_pointer - Write func for memory address
 * @buffer: char arrays
 * @ind: Index to start buffer number starts
